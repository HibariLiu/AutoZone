...
from  AutoTestPlat import settings
...
urlpatterns = [
    ...
    path('appcase_periodic_task/addwebtask_data/',appviews.add_task_appcase_test),
    ...
    path('App_test_robotframework/add_web_casename/', appviews.add_app_casename),
